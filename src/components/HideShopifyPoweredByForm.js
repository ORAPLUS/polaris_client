...
class HideShopifyPoweredByForm extends Component {
  defaultState = {
    checked: false
  };
  state = {
      ...
      <Page title="Theme settings">
        ...
        <Layout>
          <Layout.AnnotatedSection
            title="Hide Powered By Shopify"
            description='We will use this to remove "Powered by Shopify link" in the footer.'
          >
            <Card sectioned>
              <FormLayout>
                <Checkbox
...
export default HideShopifyPoweredByForm;
